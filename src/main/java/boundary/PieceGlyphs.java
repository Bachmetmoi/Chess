...
/**
 * Shared piece-to-glyph rendering for the board screens. Solid (filled) glyphs
 * are used for both colours; the fill colour set here distinguishes white from
...
final class PieceGlyphs {
    ...
    /** A coloured {@link Text} node for the piece, sized to {@code fontSize}. */
